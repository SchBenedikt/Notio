...
import { Pencil, Trash2, Layers, MoreVertical, PlayCircle, BookCopy, Star } from "lucide-react";
...
export function StudySetCard({ studySet, subjectName, onSelect, onEdit, onDelete, onToggleFavorite, animationIndex }: StudySetCardProps) {
  return (
            ...
            <CardHeader>
                <div className="flex justify-between items-start gap-2">
                    ...
                    <div className="flex items-center">
                        <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={(e) => { e.stopPropagation(); onToggleFavorite(studySet.id, !!studySet.isFavorite)}}>
                            <Star className={cn("h-5 w-5 transition-colors", studySet.isFavorite ? "text-yellow-400 fill-current" : "text-muted-foreground/60 hover:text-yellow-400")} />
                        </Button>
                        <DropdownMenu>
