...
export const defaultLayouts: Layouts = {
    lg: [
        ...
        { i: 'upcoming',    x: 0, y: 2, w: 2, h: 2, minW: 1, minH: 2 },
        { i: 'tutor',       x: 2, y: 2, w: 1, h: 2, minW: 1, minH: 2 },
    ],
    md: [
        { i: 'performance', x: 0, y: 0, w: 2, h: 2 },
        { i: 'actions',     x: 0, y: 2, w: 1, h: 2 },
        { i: 'upcoming',    x: 1, y: 2, w: 1, h: 2 },
        { i: 'tutor',       x: 0, y: 4, w: 2, h: 2 },
    ],
    sm: [
        { i: 'performance', x: 0, y: 0, w: 1, h: 2 },
        { i: 'actions',     x: 0, y: 2, w: 1, h: 2 },
        { i: 'upcoming',    x: 0, y: 4, w: 1, h: 2 },
        { i: 'tutor',       x: 0, y: 6, w: 1, h: 2 },
    ],
    xs: [
        { i: 'performance', x: 0, y: 0, w: 1, h: 2 },
        { i: 'actions',     x: 0, y: 2, w: 1, h: 2 },
