...
const GradeCalculator = ({ subject, grades, finalGrade: finalGradeString }: { subject: Subject; grades: Grade[], finalGrade: string }) => {
          ...
          {grades.length > 0 ? (
             <div className="grid md:grid-cols-2 md:gap-x-8 items-start">
                ...
                <div className="mt-6 md:mt-0 space-y-4">
                    ...
                    <GradeCalculator subject={subject} grades={grades} finalGrade={finalGrade} />
